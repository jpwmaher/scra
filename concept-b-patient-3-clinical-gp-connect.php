                                        ...
                                        <li class="accordion-item" data-accordion-item="">
                                            ...
                                            <div class="accordion-content" data-tab-content="" role="tabpanel" aria-labelledby="1234-accordion-label" aria-hidden="true" id="1234-accordion">
                                                <ul class="menu expanded vertical" data-magellan data-deep-linking="true">
                                                    <li><a href="concept-b-patient-3-clinical.php#first">Allergies &amp; Sensitivities</a></li>
                                                    <li><a href="concept-b-patient-3-clinical.php#second">Acute Medications</a></li>
                                                    <li><a href="concept-b-patient-3-clinical.php#third">Current Repeat Medications</a></li>
                                                    <li><a href="concept-b-patient-3-clinical.php#fourth">Past Repeat Medications</a></li>
                                                    <li><a href="concept-b-patient-3-clinical.php#fifth">Diagnoses</a></li>
                                                    <li><a href="concept-b-patient-3-clinical.php#sixth">Problems &amp; issues</a></li>
                                                    <li><a href="concept-b-patient-3-clinical.php#seventh">Observations</a></li>
                                                    <li><a href="concept-b-patient-3-clinical.php#eighth">Treatments</a></li>
                                                    <li><a href="concept-b-patient-3-clinical.php#ninth">Results</a></li>
                                                    <li><a href="concept-b-patient-3-clinical.php#tenth">Care events</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                ...
                                <div class="docs-nav" id="docs-menu">
                                    ...
                                    <ul class="accordion docs-nav-category" data-accordion="12345-accordion" data-allow-all-closed="true" data-multi-expand="false" role="tablist">
                                        ...
                                        <li class="accordion-item" data-accordion-item="">
                                            ...
                                            <div class="accordion-content" data-tab-content="" role="tabpanel" aria-labelledby="lvidlv-accordion-label" aria-hidden="true" id="lvidlv-accordion">
                                                <ul class="docs-nav-subcategory">
                                                    <li><a href="concept-b-patient-3-clinical-mhcp.php" class="">Mental Health Crisis Plan</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li class="accordion-item" data-accordion-item="">
