<div id="first-column" class="cell medium-shrink medium-cell-block-y content-column show-for-medium first-column-medium">
    ...
    <div class="grid-x grid-padding-x medium-up-1 large-up-1">
        ...
        <div class="cell">
            <div class="tab-icon">
                <a id="vert-tab-2" href="<?php echo $link_tab_2 ?>" class="expanded tab-icon-button button">
        ...
        <div class="cell">
            <div class="tab-icon tab-icon-alert">
                <a id="vert-tab-5" href="#" class="expanded tab-icon-button button">
                                ...
                                <span class="tab-icon-label">                <?php echo $label_alerts ?> (3)</span>
                                </a>
            </div>
        </div>
        ...
        <div class="cell">
            <div class="tab-icon tab-icon-flag">
                <a id="vert-tab-6" href="#" class="expanded tab-icon-button button">
                                ...
                                <span class="tab-icon-label">                <?php echo $label_flags ?> (2)</span>
                                </a>
            </div>
        </div>
