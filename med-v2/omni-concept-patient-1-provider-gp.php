        ...
        <div class="cell shrink header medium-cell-block-container">
            ...
            <div class="cell medium-auto medium-cell-block-container">
                ...
                <div class="grid-x grid-padding-x">
                    ...
                    <!-- Vertical tabs icon -->
                    <?php include("include-concept-omni-column-1-provider-patient-1.php"); ?>

                    <!-- Menu -->
                    <?php include("include-concept-omni-column-2-provider-gp-patient-1.php"); ?>

                    <!-- Main content -->
                    <?php include("include-concept-omni-column-3-provider-gp-patient-1.php"); ?>

                    <!-- Info bar -->
                    <?php include("include-concept-omni-column-4-provider-gp-patient-1.php"); ?>
