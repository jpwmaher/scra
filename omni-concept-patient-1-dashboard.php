        ...
        <div class="cell shrink header medium-cell-block-container">
            ...
            <div class="cell medium-auto medium-cell-block-container">
                ...
                <div class="grid-x grid-padding-x">
                    ...
                    <!-- Vertical tabs icon -->
                    <?php include("include-concept-omni-column-1-dashboard-patient-1.php"); ?>

                    <!-- Menu
                    <?php include("include-concept-omni-column-2-patient-1.php"); ?> -->

                    <!-- Main content -->
                    <?php include("include-concept-omni-column-3-patient-1-dashboard.php"); ?>
